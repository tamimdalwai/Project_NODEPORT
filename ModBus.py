...
async def check_connection(client, plc_id, retry_interval=5):
    ...
    try:
        ...
        logger.error(f"Connection error for {plc_id}: {e}")
                    ...
                    try:
                        ...
                        with data_lock:
                            latest_modbus_data[plc_id] = {
                                ...
                                "input_status_states": input_states or {},
                                "input_register_states": register_states or {}
                            }
                        # Save to Excel
...
# #
# # # ModBus.py
# # latest_modbus_data = {}  # Add this line at the top of the file
# #
# # async def modbus_client_loop(plc_id, ip, port, sampling_frequency):
...
# #     async with AsyncModbusTcpClient(ip, port=port) as client:
# #         while True:
# #             # ... (existing connection checks and logic)
# #
# #             try:
# #                 # Read all registers in parallel
# #                 coil_states, input_states, register_states = await asyncio.gather(
# #                     read_registers(client, client.read_coils, coils, sampling_frequency),
# #                     read_registers(client, client.read_discrete_inputs, input_status, sampling_frequency),
# #                     read_registers(client, client.read_input_registers, input_register, sampling_frequency, max_count=125)
# #                 )
# #
# #                 # Update the global latest_modbus_data
# #                 latest_modbus_data[plc_id] = {
# #                     "coil_states": coil_states,
# #                     "input_status_states": input_states,
# #                     "input_register_states": register_states
